                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="map" class="margin_20">
                                <mapplic-png-map id="details" ref="pngmap_ref" :height="314" :hovertip="true" :storelist="allStores" :floorlist="floorList" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height" @updateMap="updatePNGMap"></mapplic-png-map>
                            </div>
                            ...
                            <div v-if="deliveryAvailable" class="margin_30">
                                ...
                                <div class="store_details_delivery">
                                    ...
                                    <img v-if="hasPostmates" class="delivery_option" src="//codecloud.cdn.speedyrails.net/sites/5ddeafc56e6f6416db790000/image/png/1569270191004/postmates.png" alt="Delivery available with Postmates" />
                                    <div v-if="hasRestaurantDelivery" class="delivery_option"><span>Restaurant Delivery</span></div>
                                    <img v-if="hasUberEats" class="delivery_option" src="//codecloud.cdn.speedyrails.net/sites/5ddeafc56e6f6416db790000/image/png/1568400422000/ubereats.png" alt="Delivery available with Uber Eats" />
                                    ...
                                    <div class="col-md-6" v-if="storeEvents" v-for="item in storeEvents">
                                        <div class="feature_item_container">
                                	        <router-link class="tile" :to="{ name: 'eventDetails', params: { id: item.slug }}">
                                    			<img :src="item.image_url" :alt="item.name" class="store_coupon_img">
                                				<div class="details">
                        					    	<span class="title">
                        					            <h3>{{ item.name }}</h3>
                    					            </span>
                                    ...
                                    <div class="col-md-6" v-if="storeCoupons" v-for="item in storeCoupons">
                                        <div class="feature_item_container">
                                	        <router-link class="tile" :to="{ name: 'couponDetails', params: { id: item.slug }}">
                                    			<img class="store_coupon_img" :src="item.image_url" :alt="item.name">
                                				<div class="details">
                        					    	<span class="title">
                        					            <h3>{{ item.name }}</h3>
                    					            </span>
                ...
                updateCurrentStore(id) {
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                            ...
                            if (_.includes(subcategories, 8831)) {
                                this.hasUberEats = true;
                            }
                            if (_.includes(subcategories, 8829)) {
                                this.hasDoordash = true;
                            }
                            if (_.includes(subcategories, 8230)) {
                                this.hasGrubhub = true;
                            }
                            if (_.includes(subcategories, 8832)) {
                                this.hasPostmates = true;   
                            }
                            if (_.includes(subcategories, 8833)) {
