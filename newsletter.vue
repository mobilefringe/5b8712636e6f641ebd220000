                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/ulikhh/" method="post" @submit.prevent="validateBeforeSubmit">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <input v-model="form_data.last_name" required class="margin_20 form-control" id="fieldfihudi" name="cm-ulikhh-ulikhh" type="text" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
        ...
        return Vue.component("newsletter-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/peninsula-newsletter.json"}), this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {
